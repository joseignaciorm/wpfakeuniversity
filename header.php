      ...
      <div class="site-header__menu group">
        ...
        <div class="site-header__util">
          ...
          if (is_user_logged_in()) { ?>
            ...
            <?php // Avatar function primer parametro es el id del user, segundo parametro el tamaño de la imágen ?>
            <span class="site-header__avatar"><?php echo get_avatar(get_current_user_id(), 60); ?></span>
            <span class="text">Log Out</span>
            </a>
          <?php } else { ?>
            <a href="<?php echo wp_login_url(); ?>" class="btn btn--small btn--orange float-left push-right">Login</a>
            <a href="<?php echo wp_registration_url(); // esc_html(site_url('/wp-signup.php')); ?>" class="btn btn--small  btn--dark-orange float-left">Sign Up</a>
          <?php } ?>
